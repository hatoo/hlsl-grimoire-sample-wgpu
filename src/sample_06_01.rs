...
async fn run(event_loop: EventLoop<()>, window: Window) {
    ...
    let cube_normal = include_bytes!("../assets/Tileable_stucco_plaster_wall_texture_NORMAL.jpg");
    let normal_map =
        texture::Texture::from_bytes(&device, &queue, cube_normal, "Normal Map").unwrap();
